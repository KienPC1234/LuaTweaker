...
-- 2. KubeJS-style Rich Item Definitions (using & color codes, enchantments, and NBT)
local customSword = item("minecraft:diamond_sword", 1)
    ...
    :withEnchantment("minecraft:fire_aspect", 2)
    :withNbt("{CustomModelData:100}")
...
recipes:addShapeless("luatweaker:legendary_sword_recipe", customSword, {
    woodTag,
    ironOrCopper,
...
-- 9. Anvil Recipe: Wooden Sword + Emerald -> Excalibur Diamond Sword (1 XP level)
recipes:addAnvil(
...
-- 10. Brewing Stand Potion Recipe: Water Bottle + Diamond -> Potion of Night Vision
recipes:addBrewing(
