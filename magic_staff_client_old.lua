...
-- so this listener only plays client-side feedback ΓÇö never re-fires the server)
...
-- WORLD-SPACE TARGET OUTLINE ΓÇö computed in pure Lua from client-side entity data.
